...
class RoleController extends Controller
{
    ...
    public function store(RoleCreateRequest $request)
    {
        ...
        event(new \App\Events\userActionEvent('\App\AdminRole',$role->id,1,"用户".Auth::user()->username."{".Auth::user()->id."}添加角色".$role->name."{".$role->id."}"));
    ...
    public function update(RoleUpdateRequest $request, $id)
    {
        ...
        $role->givePermissionsTo($request->get('permissions',[]));
        event(new \App\Events\userActionEvent('\App\AdminRole',$role->id,3,"用户".Auth::user()->username."{".Auth::user()->id."}编辑角色".$role->name."{".$role->id."}"));
    ...
    public function destroy($id)
    {
        ...
        event(new \App\Events\userActionEvent('\App\AdminRole',$role->id,2,"用户".Auth::user()->username."{".Auth::user()->id."}删除角色".$role->name."{".$role->id."}"));
        return redirect()->back()
            ->withSuccess("删除成功");
    }
}
