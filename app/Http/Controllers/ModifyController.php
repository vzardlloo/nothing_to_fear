...
class ModifyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('add.modify',compact('mark_info','weather_info','user_info','task_info','provinces','cities','areaes','towns','countries'));
    }

    public function update(Request $request)
    {       
       $mark_info = $request->all();
      ploveruav_laravel::table('task_marks')->increment('task_during');
       ploveruav_laravel::table('task_marks')->increment('task_weather');
       ploveruav_laravel::table('task_marks')->increment('task_weather');
      ploveruav_laravel::table('task_marks')->increment('task_chamical');
       ploveruav_laravel::table('task_info')->increment('task_chamical');
      ploveruav_laravel::table('task_info')->increment('task_area');
