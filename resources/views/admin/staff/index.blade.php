                ...
                <div class="col-xs-12">
                    ...
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">员工名</th>
                            <th class="hidden-sm">员工手机号</th>
                            <th class="hidden-md">员工主要工作</th>
                            <th class="hidden-md">员工所在组</th>
                ...
                columnDefs: [
                    {
                        ...
                        var caozuo = '<a style="margin:3px;" href="/admin/staff/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                        if (row['id'] != 1) {
